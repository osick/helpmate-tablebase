...
| 2–4 | 66 | complete |
| 5 | 220 | complete |
| 6 | 645 | 31 published, 614 outstanding |
| 7+ | — | not attempted |

**317 files, 172.5 GiB.** Deepest mate in the corpus: h#17.
...
At six pieces, 614 classes are still unsolved, and **269 of them need only
...
Thank you to everyone who spent their machine's time on this.

| contributor | tables | notes |
| --- | --- | --- |
| [**T31M**](https://huggingface.co/T31M) | KRBvkqq, KRBvkqr, KRBvkqb, KRBvkqn, KRBvkrr, KRBvkrb, KRBvkrn, KRBvkbb, KRBvkbn, KRBvknn, KRBvkqp, KRBvkrp, KRBvkbp, KRBvknp, KRBvkpp | [PR #1](https://huggingface.co/datasets/osick/helpmate-tables/discussions/1): king, rook and bishop against every three-man Black set, 120 GiB compressed, computed on a 192-thread, 369 GiB machine. The pawn tables need about 85 GiB of RAM each. KRBvkqp and KRBvkrp tie the deepest mate in the corpus, h#17. |
